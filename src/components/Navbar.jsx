...
const Navbar = () => {
	return (
		<nav className="w-screen flex justify-between text-white mt-10">
			<Link to={"/"}><h1 className="ml-24  font-bold text-4xl">E M A G</h1></Link>
			<ul className="flex">
				<Link to={"/"}><li className="mx-12 font-light hover:font-normal hover:cursor-pointer text-2xl">Home</li></Link>
